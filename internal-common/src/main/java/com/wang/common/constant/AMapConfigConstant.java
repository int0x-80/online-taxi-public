...
public class AMapConfigConstant {
    ...
    public static final String TERMINAL_ROUND_URL = "https://tsapi.amap.com/v1/track/terminal/aroundsearch";
    ...
    public static final String ADDRESSCODE = "adcode";
